    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center">
            ...
            <div class="sidebar-brand-text mx-3"
                 style="color:var(--blue);font-weight: 700;"><?= isset($_SESSION['utilisateur_connecter_admin']) ? $_SESSION['utilisateur_connecter_admin']['profil'] : 'Profil' ?></div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?= PATH_PROJECT ?>administrateur/commandes/liste-commandes">Liste
                        des Commandes</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?= PATH_PROJECT ?>administrateur/chambres/liste-chambres">Liste des
                        chambres</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?= PATH_PROJECT ?>administrateur/repas/liste-repas">Listes des
                        repas</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?= PATH_PROJECT ?>administrateur/users/liste-users">Listes des
                        utilisateurs</a>
                </div>
            </div>
        </li>
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <div class="nav-link">
                            ...
                            <img class="img-profile rounded-circle"
                                 src="<?= $_SESSION['utilisateur_connecter_admin']['avatar'] == 'Aucune_image' ? PATH_PROJECT . 'public/images/default_profil.jpg' : $_SESSION['utilisateur_connecter_admin']['avatar'] ?>">
                        </div>
