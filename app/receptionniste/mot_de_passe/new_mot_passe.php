                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <?php
                                ...
                                <form action="<?= PATH_PROJECT ?>receptionniste/mot_de_passe/traitement_new_mot_passe" method="post" class="user" novalidate>
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="<?= PATH_PROJECT ?>receptionniste/connexion/index">Vous avez déjà un compte ? Connectez-vous!</a>
                                </div>
                                <div class="text-center">
                                    <a class="small" href="<?= PATH_PROJECT ?>receptionniste/inscription/index">Créez un compte !</a>
                                </div>
                            </div>
                        </div>
                    </div>
