...
<header id="headerwrap" class="backstretched no-overlay fullheight">
    <div class="container vertical-center">
        <div class="intro-text vertical-center text-left smoothie" style="font-family: Playfair Display , sans-serif;">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 mt-4 mt-lg-0">
                <div class="box" data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <p>
                        Nous vous offrons un acceuil chaleureux tout en vous faisant déguster notre cocktail de
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            ?>
                                                    ...
                                                    <div class="card-body">
                                                        <div style="display: flex; align-items: center; justify-content: space-between; font-family: Playfair Display, serif; font-size :larger; font-weight: 600;">
                                                            <p class="card-text" style="color:black; margin-bottom: 0;">
                                                                Chambre <?php echo $chambre['num_chambre']; ?> de type <?php echo $chambre['lib_typ']; ?> </p>
                                                            <!-- <a href="<?= PATH_PROJECT . 'client/chambres/details_chambre/' . $chambre['num_chambre'] ?>">Détails</a> -->

                                                            <!-- Button Détails modal -->
                                                            <p style="margin-bottom: 0;" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detailsModal-<?php echo $chambre['num_chambre']; ?>" data-num-chambre="<?php echo $chambre['num_chambre']; ?>">
                                                                Détails
                                                            </p>
                                        ...
                                        <!-- Modal  Détails-->
                                        <div class="modal fade" id="detailsModal-<?php echo $chambre['num_chambre']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="font-family: Open Sans , sans-serif;">
