                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?= PATH_PROJECT ?>public/images/specials-1.png" alt=""
                                        class="img-fluid" />
                                </div>
                                <div class="carousel-item">
                                    <img src="<?= PATH_PROJECT ?>public/images/specials-3.png" class="d-block w-100"
                                        alt="..." />
                                </div>
                                <div class="carousel-item">
                                    <img src="<?= PATH_PROJECT ?>public/images/specials-4.png" class="d-block w-100"
                                        alt="..." />
                                </div>
                            </div>
                        ...
                        <div class="card-body px-0">
                            ...
                            ?>
                                <h5 style="color: #cda45e; text-align:center; margin-bottom: 20px;">
                                    ...
                                    Vous pouvez consulter la liste de vos commandes dans le tableau de bord liste des
                                    commandes après une commande.
                                </h5>
                            <?php
                            }
                            ?>
                            <form action="<?= PATH_PROJECT ?>client/restaurant/traitement-commande" method="post"
                                class="user">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="number" name="num_chambre" id="num_chambre" class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Prix total du repas"
                                            id="pu_repas" name="pu_repas[]" readonly>
                                ...
                                <div class="float-right" style="text-align: right;">
                                    ...
                                    <button type="submit" name="enregistrer" class="btn btn-success"
                                        style="--bs-btn-color: #fff; --bs-btn-bg: #013534; --bs-btn-border-color: #000000; --bs-btn-hover-color: #fff; --bs-btn-hover-bg: #9d6b15; --bs-btn-hover-border-color: #000000;">
                                        Enregistrer
                                    </button>
                                </div>
