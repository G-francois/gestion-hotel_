            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="btns">
                        ...
                        <a href="<?= PATH_PROJECT ?>client/restaurant/commande"
                           class="btn-book animated fadeInUp scrollto">Faire une Commande</a>
                    </div>
                </div>
                    ...
                    <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
						...
						foreach ($menuItems as $menuItem) {
                            ...
                            <div class="col-lg-6 menu-item <?= 'filter-' . strtolower($menuItem['categorie']); ?>">
                                <img src="<?= $menuItem['photos'] == 'Aucune_image' ? PATH_PROJECT . 'public/images/default_chambre.jpeg' : $menuItem['photos'] ?>"
                                     class="menu-img" alt=""/>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="<?= PATH_PROJECT ?>public/images/specials-3.png" alt=""
                                             class="img-fluid"/>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="<?= PATH_PROJECT ?>public/images/specials-4.png" alt=""
                                             class="img-fluid"/>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-5">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="<?= PATH_PROJECT ?>public/images/specials-5.png" alt=""
                                             class="img-fluid"/>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="row event-item">
                                <div class="col-lg-6">
                                    <img src="<?= PATH_PROJECT ?>public/images/event-birthday.jpg" class="img-fluid"
                                         alt=""/>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="row event-item">
                                <div class="col-lg-6">
                                    <img src="<?= PATH_PROJECT ?>public/images/event-private.jpg" class="img-fluid"
                                         alt=""/>
                                </div>
                                <div class="col-lg-6 pt-4 pt-lg-0 content">
                        ...
                        <div class="swiper-slide">
                            <div class="row event-item">
                                <div class="col-lg-6">
                                    <img src="<?= PATH_PROJECT ?>public/images/event-custom.jpg" class="img-fluid"
                                         alt=""/>
                                </div>
                                <div class="col-lg-6 pt-4 pt-lg-0 content">
