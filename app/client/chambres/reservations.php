                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <ol>
                                ...
                                <li>
                                    <strong>La date de début de séjour dans une chambre ne peut être antérieure à la date actuelle (<?= date('d / m / Y') ?>).</strong>
                                </li>
                            </ol>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="date" name="chambre1[deb_occ]" id="inscription-deb_occ" class="form-control" placeholder="Veuillez entrer votre date de début occupation" value="" min="<?= date('Y-m-d'); ?>" required>
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="date" name="chambre1[fin_occ]" id="inscription-fin_occ" class="form-control" placeholder="Veuillez entrer votre date de fin occupation" value="" min="<?= date('Y-m-d'); ?>" required>
                                        </div>
