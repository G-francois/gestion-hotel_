        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <h2>
                    ...
                    grandes, meublées et
                    décorées dans un style minimaliste, qui permet une utilisation optimal de l'espace. Nous vous
                    invitons
        ...
        <form action="<?= PATH_PROJECT ?>client/chambres/traitement-chambre" method="post" class="user" novalidate>
            <div class="row">
                                    ...
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            <div style="display: flex; align-items: center; justify-content: space-between; font-family: Playfair Display, serif; font-size :larger; font-weight: 600;">
                                                <p class="card-text" style="color:black; margin-bottom: 0rem;">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <?php if ($page > 1) : ?>
                            <li class="page-item"><a class="page-link" href="<?= PATH_PROJECT . 'client/chambres/index/' ?><?= $page - 1 ?>">Précédent</a>
                            </li>
                        <?php endif; ?>
                        <li class="page-item active"><a class="page-link" href="#"><?= $page ?></a></li>
                        <?php if (!empty($liste_chambres) && count($liste_chambres) == 9) : ?>
                            <li class="page-item"><a class="page-link" href="<?= PATH_PROJECT . 'client/chambres/index/' ?><?= $page + 1 ?>">Suivant</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </nav>
