...
<!-- LES STYLES UTILISEES LORS DE LA PAGE PROFIL DU CLIENT -->
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center" style="color: #cda45e;">
                            <a href="<?= $_SESSION['utilisateur_connecter_client']['avatar'] == 'Aucune_image' ? PATH_PROJECT . 'public/images/default_profil.JPG' : $_SESSION['utilisateur_connecter_client']['avatar'] ?>" class="gallery-lightbox" data-gall="gallery-item">
                                <img src="<?= $_SESSION['utilisateur_connecter_client']['avatar'] == 'Aucune_image' ? PATH_PROJECT . 'public/images/default_profil.JPG' : $_SESSION['utilisateur_connecter_client']['avatar'] ?>" style="width: 130px;" alt="Profile" class="rounded-circle , img-fluid">
                            </a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" style="text-transform: uppercase;">Mettre à jour la
                                                                photo de profil</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="row mb-3">
                                                                <label for="MP" class="col-12 col-form-label" style="color: #070b3a;">Veuiller entrer votre
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" name="change_photo" class="btn btn-primary">Valider
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="text-center" style="color: #070b3a;">
                                ...
                                <div class="modal fade" id="suppression_photoModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel" style="text-transform: uppercase;">Supprimer la photo de
                                                    profil</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row mb-3">
                                                    <label for="MP1" class="col-12 col-form-label" style="color: #070b3a;">Veuiller entrer votre mot de
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="supprimer_photo" class="btn btn-primary">Valider
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row mb-3">
                                                        ...
                                                        <label for="MP2" class="col-12 col-form-label" style="color: #d11818;">
                                                            Vous êtes sûre d'effectuer cette action ? Après cette action votre compte sera supprimer de façon définitive.
                                                            Si oui, veuillez entrer votre mot de passe pour appliquer l'action.
                                                        </label>
                                                        <br>
                                                        <div class="col-md-8 col-lg-12">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" name="suppression" class="btn btn-primary">Valider
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row mb-3">
                                                        ...
                                                        <label for="MP3" class="col-12 col-form-label" style="color: #d11818;">
                                                            Vous êtes sûre d'effectuer cette action ? Après cette action, vous ne serez plus en
                                                            mesure de vous connecter. Si oui, veuillez entrer votre mot de passe pour appliquer
                                                            l'action. Pour réactiver votre compte, veuillez contacter un administrateur.
                                                        </label>
                                                        <br>
                                                        <div class="col-md-8 col-lg-12">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" name="desactivation" class="btn btn-primary">Valider
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="text-center" style="color: #070b3a;">
                                    ...
                                    <div class="modal fade" id="ModifierinformationsModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel" style="text-transform: uppercase;">Modifier les informations
                                                        de mon compte</h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="passwordImput" class="col-12 col-form-label" style="color: #070b3a;">Veuillez entrer votre mot de
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" name="sauvegarder" class="btn btn-primary">Valider
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
